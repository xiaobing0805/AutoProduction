...
/***/ function(module, exports) {
	...
	*/
	module.exports = {
		 ...
		 */
		//生成运单号
		sfwbnum:function(heads){
			var prefix = this.pick(heads)+"";
			var pre = prefix!=""&&prefix!="undefined"&& prefix!=undefined ? prefix : "";
	...
	*/
	...
	module.exports = {
	    ...
	    sfaddress: function() {
	    	...
	    	var city = this.city(pro);
	    	var county = this.county(city);
	    	return county;
	    },
	    //sfphone: function() {},
	    // areacode: function() {},
	...
	module.exports = {
		...
		*/
		increment: function() {
			...
			var key = parseInt(month+""+strDate+""+hour+""+min+""+sec);
